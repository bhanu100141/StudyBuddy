      ...
      <div className="min-h-screen dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="max-w-4xl mx-auto p-6 md:p-8">
          ...
          <div className="space-y-6">
            {/* Appearance Settings */}
            <div className="dark:bg-slate-900/50 bg-white/70 backdrop-blur-xl rounded-2xl border dark:border-white/10 border-gray-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm dark:text-gray-400 text-gray-600">Customize how Study Buddy looks</p>
                </div>
              </div>

              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium dark:text-gray-300 text-gray-700 mb-3 block">
                    Theme
                  </label>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-xl border transition-all ${
                          theme === option.value
                            ...
                            : 'dark:bg-white/5 bg-gray-100 dark:border-white/10 border-gray-300 dark:text-gray-400 text-gray-600 dark:hover:bg-white/10 hover:bg-gray-200'
                        }`}
                      >
            ...
            <div className="dark:bg-slate-900/50 bg-white/70 backdrop-blur-xl rounded-2xl border dark:border-white/10 border-gray-200 p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={setting.key}
                    className="flex items-center justify-between p-4 dark:bg-white/5 bg-gray-100 rounded-xl border dark:border-white/5 border-gray-200 dark:hover:border-white/10 hover:border-gray-300 transition-colors"
                  >
                    <div>
                      <div className="dark:text-white text-gray-900 font-medium">{setting.label}</div>
            ...
            <div className="dark:bg-slate-900/50 bg-white/70 backdrop-blur-xl rounded-2xl border dark:border-white/10 border-gray-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm dark:text-gray-400 text-gray-600">Manage your password and security</p>
                </div>
              </div>

              <div className="space-y-4">
                <div>
                  <label className="flex items-center gap-2 text-sm font-medium dark:text-gray-300 text-gray-700 mb-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="dark:bg-white/5 bg-gray-100 dark:border-white/10 border-gray-300 dark:text-white text-gray-900 dark:focus:border-blue-500/50 focus:border-blue-500 pr-10"
                      placeholder="Enter current password"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPasswords(!showPasswords)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 dark:text-gray-400 text-gray-600 dark:hover:text-white hover:text-gray-900"
                    >
                      {showPasswords ? (
            ...
            <div className="bg-red-500/10 backdrop-blur-xl rounded-2xl border border-red-500/30 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-300/70 dark:text-red-300/70">
